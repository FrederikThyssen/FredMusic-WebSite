...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border-gold-300 bg-gold-300 text-night-950 shadow-glow hover:-translate-y-0.5 hover:border-gold-500 hover:bg-gold-500 hover:text-night-950 hover:shadow-[0_18px_50px_rgba(255,185,0,0.28)]",
  secondary:
  ...
  weddingPrimary:
    "border-gold-400 bg-gold-500 text-night-950 hover:border-gold-500 hover:bg-gold-400",
  weddingSecondary:
