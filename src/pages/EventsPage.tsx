...
export function EventsPage() {
  return (
    <div className="bg-night-950 text-ivory">
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:min-h-[620px] lg:px-8 lg:py-28">
        <img
          src="/images/conception/galerie-evenement-022.jpg"
          alt=""
          className="absolute inset-0 hidden h-full w-full object-cover object-[center_44%] opacity-48 lg:block"
          aria-hidden="true"
        />
        ...
        <div className="relative mx-auto w-full max-w-7xl">
          <HeroMedia
            src="/images/conception/galerie-evenement-022.jpg"
            alt="Soirée privée avec piste de danse, invités et faisceaux lumineux"
